 ...
 */
export const createChangeCurrentLine = (deps: Pick<MotionChangeDeps, 'updateInfoContainer'>) => () => {
 ...
 */
export const createChangeToNextWord = (deps: Pick<MotionChangeDeps, 'deleteToNextWord' | 'updateInfoContainer'>) => () => {
 ...
 */
export const createChangeToEndOfLine = (deps: Pick<MotionChangeDeps, 'deleteToEndOfLine' | 'updateInfoContainer'>) => () => {
 ...
 */
export const createChangeToBeginningOfLine = (deps: Pick<MotionChangeDeps, 'deleteToBeginningOfLine' | 'updateInfoContainer'>) => () => {
 ...
 */
export const createChangeToPreviousParagraph = (deps: Pick<MotionChangeDeps, 'refreshLines' | 'updateInfoContainer'>) => () => {
 ...
 */
export const createChangeToNextParagraph = (deps: Pick<MotionChangeDeps, 'refreshLines' | 'updateInfoContainer'>) => () => {
  const { refreshLines, updateInfoContainer } = deps;
  const { vim_info } = window;
  const currentLine = vim_info.active_line;
 ...
 */
export const createChangeFindCharForward = (deps: Pick<MotionChangeDeps, 'deleteFindCharForward' | 'updateInfoContainer'>) => (char: string) => {
 ...
 */
export const createChangeFindCharBackward = (deps: Pick<MotionChangeDeps, 'deleteFindCharBackward' | 'updateInfoContainer'>) => (char: string) => {
 ...
 */
export const createChangeTillCharForward = (deps: Pick<MotionChangeDeps, 'deleteTillCharForward' | 'updateInfoContainer'>) => (char: string) => {
 ...
 */
export const createChangeTillCharBackward = (deps: Pick<MotionChangeDeps, 'deleteTillCharBackward' | 'updateInfoContainer'>) => (char: string) => {
